...
{
    $ambilkata = $text;
    $ambilkata = str_replace('</div><br />', '<br />', $ambilkata);
    $ambilkata = str_replace('<li>', '<li hidden>', $ambilkata);
    $ambilkata = str_replace('<p><strong>', '<p hidden>', $ambilkata);
    return $ambilkata;
}
...
//link    
$regex = '/<div class="soraurl list-download">(.*?)<div class="animeinfo">/s';
